...
#import "YodaChatViewController.h"
...
@implementation YodaChatViewController
                      ...
                      date:(NSDate *)date
{
    ...
    // send the text to be converted to the message.
    ...
    //begin the completiomn of Translation
    [self TranslatePressed:message.text];
    
    [self finishSendingMessageAnimated:YES];
}

- (void)TranslatePressed:(NSString*)sentMessage
{
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        message.text = [[APIManager sharedInstance]getyodaSpeakTranslation:[sentMessage stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
- (NSAttributedString *)topLabelAttributedStringForItem:(QBChatMessage *)messageItem {
    ...
    NSMutableAttributedString *attrStr = [[NSMutableAttributedString alloc] initWithString:@"YODA TRANSLATED:" attributes:attributes];
